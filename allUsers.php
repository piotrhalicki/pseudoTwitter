<div style="text-align: center">
	...
	<?php 								// Wyświetlenie wszystkich zarejestrowanych Userów + dodawanie do znajomych
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		if(isset($_POST['addFriend'])) {
			$sql = ("INSERT INTO Friends (friend1_id, friend2_id) 
					 VALUES ('{$_SESSION['user_id']}', '{$_POST['ID']}')");
			$conn->query ($sql);
			var_dump($_POST);
			var_dump($row['id']);
			var_dump($row['name']);
